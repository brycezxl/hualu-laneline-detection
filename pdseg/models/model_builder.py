...
from models.modeling import deeplab, unet, icnet, pspnet, hrnet, fast_scnn, ocrnet, mt_hrnet, post_hrnet
...
def seg_model(image, class_num):
    ...
    elif model_name == 'post-hrnet':
        logits = post_hrnet.post_hrnet(image, class_num)
    else:
        raise Exception(
